...
#define Kp x // experiment to determine this, start by something small that just makes your bot follow the line at a slow speed
#define Kd  y // experiment to determine this, slowly increase the speeds and adjust this value. ( Note: Kp < Kd) 
#define RIGHT_MAX_SPEED 160 // max speed of the robot
#define LEFT_MAX_SPEED 160 // max speed of the robot
